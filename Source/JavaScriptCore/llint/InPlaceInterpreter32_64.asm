...
instructionLabel(_br)
    ...
    # number to keep
    loadh IPInt::MDBranchTarget::toKeep[PM, MC], t5
...
instructionLabel(_global_set)
    ...
    loadb IPInt::MDGlobal::bindingMode[PM, MC], t5
    # get global addr
    loadp CodeBlock[cfr], t0
    loadp Wasm::Instance::m_globals[t0], t0
    # get value to store
...
instructionLabel(_i32_load_mem)
    ...
    # pop index
    popInt32(t0)
    loadi IPInt::MDConst32::value[PM, MC], t1
    ipintWithMemory()
...
instructionLabel(_i64_const)
    # i64.const
    # Load pre-computed value from metadata
    load2ia IPInt::MDConst64::value[PM, MC], t0, t1
    # Push to stack
    pushInt64(t1, t0)
...
mintAlign(_call)
    ...
    # Set up callee slot
    loadp IPInt::MDCallEntry::boxedCallee[ipintCallSavedCallee], PC
    ...
    loadh IPInt::MDCallReturn::stackSlots[PM], t5  # number of stack args
    leap [sp, t5, 8], sp
