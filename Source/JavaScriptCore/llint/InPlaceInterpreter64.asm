...
mintAlign(_call)
    ...
    storeq wasmInstance, ThisArgumentOffset - Callee[sp]
    ...
    loadh IPInt::MDCallReturn::stackSlots[PM], ws0  # number of stack args
    leap [sp, ws0, 8], sp
    ...
    loadh IPInt::MDCallReturn::argumentCount[PM], ws0
    lshiftq 4, ws0
    addq ws0, sp
    addq constexpr (sizeof(IPInt::MDCallReturn)), PM
    mintRetDispatch()
